...
-- 2025-08-27,PNguyen,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_PNguyen')
	 Begin 
	  Alter Database [Assignment07DB_PNguyen] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_PNguyen;
	 End
	Create Database Assignment07DB_PNguyen;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_PNguyen;
